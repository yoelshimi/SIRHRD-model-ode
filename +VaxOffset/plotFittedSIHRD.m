function plotFittedSIHRD(vaxEfficiency, p_cautious,...
    ...
    figure; 
    plot(infections, "DisplayName", "measured infections", "r.");
    hold on; plot(t, dHosp_est, "DisplayName", "estimated hosp", "b-")
    hold on; plot(t_test, fittedDataNew(:, 2),"DisplayName", ", "k.-")
